...
int main() {
    ...
    mpz_t modulus;
    mpz_init(modulus);
    char* prme = (char *)"73eda753299d7d483339d80809a1d80553bda402fffe5bfeffffffff00000001";
    mpz_set_str(modulus, prme, 16);
    cout << "modulus : "<< modulus << endl;
    mpz_t g; mpz_init(g);
    mpz_set_ui(g, 7);
    mpz_t ssquare; mpz_init(ssquare);
    mpz_t smod; mpz_init(smod);
    mpz_t mod2; mpz_init(mod2);
